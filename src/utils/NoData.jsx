const NoData = ({
  text1 = 'We couldn’t find any items here.',
  text2 = 'Try checking back later.',
}) => {
  return (
    <div className="mx-auto flex min-h-96 w-full flex-col items-center gap-2.5 overflow-hidden overflow-x-hidden pt-2 pb-16 max-md:px-2 md:max-w-[1070px] md:pb-18 dark:text-gray-300">
      <svg
