export const recentLocationModifier = async (locations, loggedIn, deviceId) => {
  ...
  if (loggedIn)
    path = `${import.meta.env.VITE_BASE_URL}/api/userActivity/userRecentLocationData`;
...
export const favRestaurantsModifier = async (
  restaurants,
  loggedIn,
  deviceId,
) => {
  ...
  if (loggedIn)
    path = `${import.meta.env.VITE_BASE_URL}/api/userActivity/userFavRestaurantData`;
...
export const wishListedItemsModifier = async (items, loggedIn, deviceId) => {
  ...
  if (loggedIn)
    path = `${import.meta.env.VITE_BASE_URL}/api/userActivity/userWishListData`;
...
export const itemsToBeAddedInCartModifier = async (
  items,
  loggedIn,
  deviceId,
) => {
  ...
  if (loggedIn)
    path = `${import.meta.env.VITE_BASE_URL}/api/userActivity/userItemsToBeAddedInCartData`;
...
export const cartItemsModifier = async (items, loggedIn, deviceId) => {
  ...
  if (loggedIn)
    path = `${import.meta.env.VITE_BASE_URL}/api/userActivity/userCartData`;
