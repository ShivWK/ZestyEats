const VegAndNonVeg = ({ classes }) => <span className={`items-center gap-1.5 bg-gray-100 text-xs font-medium rounded-full border border-gray-300 w-fit text-gray-700 ${classes}`}>
    {/* Veg Icon - Leaf */}
    <svg
