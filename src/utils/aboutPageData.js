export const about = [
    ...
    },
    {
        ...
        lastDescription: ["It serves both as a learning platform and a demonstration of my software engineering capabilities."]
    },
    {
        title: "Core Features",
        description: "This app offers a variety of features to simulate a complete food delivery experience.",
        list: {
            mainList: ["Geolocation Access: Fetch live location using the browser's Geolocation API.",
    ...
    },
    {
        ...
        description: ["ZestyEats is built to be fast and efficient:"],
        list: {
            mainList: ["Code Splitting & Lazy Loading: Improve load speed by deferring heavy components.",
                ...
                "Smart Caching:",],
            subList: ["Uses RTK Query to automatically cache API responses (default: 60s).",
    ...
    },
    {
        ...
        description: ["Security is a core focus area in ZestyEats, including:"],
        list: {
            mainList: ["JWT-based secure authentication with refresh token support.",
    ...
    {
        title: "Tech Stack",
        description: ["ZestyEats is built using a modern MERN-based tech stack to ensure a responsive, scalable, and secure user experience. It combines powerful frontend tools with a robust backend and secure authentication mechanisms to deliver a real-world production-grade food delivery app."],
        list: {
            mainList: ["Frontend: React, Redux Toolkit, React Router DOM, Tailwind CSS, RTK Query",
            ...
            subList: ["Frontend: Vercel", "Backend: Render"],
        }
    },
    {
        title: "User Role",
        description: ["ZestyEats is a user-centric platform. While there's no dedicated admin panel, the backend is fully developer-controlled with secure logic for every user interaction — from searching to placing an order."],
    },
    {
        title: "What I Learned",
        description: ["This project deepened my understanding of:"],
        list: {
            mainList: ["Building secure, scalable REST APIs.",
        ...
        lastDescription: ["ZestyEats is more than just a clone — it’s a demonstration of production-quality software engineering, combining frontend finesse with backend power, optimized UX, and robust security."]
    }
];
