...
const Cart = () => {
  ...
  if (mainCart.length !== 0) {
    ...
    return (
      <>
        <main
          className={`min-h-[110%] w-full ${!overflowing && 'h-full'} bg-gray-200 dark:bg-black`}
        >
          <div className="mx-auto flex w-full flex-col justify-between pt-20 pb-28 max-md:gap-3 max-md:px-1.5 md:max-w-[1070px] md:flex-row md:px-3 md:pt-28">
    ...
    return (
      <>
        <main className="h-full w-full bg-white lg:h-[110%] dark:bg-black">
          <div className="mx-auto flex h-full w-full flex-col items-center justify-center gap-8 pb-12 text-red-300 max-md:px-1.5 max-md:pt-10 md:max-w-[1070px] md:px-3 md:pt-24">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="896"
              className="h-[250px] w-[300px] lg:h-[300px] lg:w-[350px]"
              height="747.97143"
            ...
            >
              ...
              <circle
                ...
                fill="#9f0712"
              />
              <circle cx="540.92726" cy="346.153" r="11.07274" fill="#9f0712" />
              <path
              ...
              <rect
                ...
                fill="#99a1af"
              />
              <rect y="745" width="896" height="2" fill="#99a1af" />
              <path
              ...
              <path
                ...
                fill="#2f2e41"
              />
              <circle cx="625.28185" cy="54.4082" r="38.40579" fill="#ffcdcc" />
              <path
            ...
            <p className="text-center text-xl font-semibold text-black md:text-2xl dark:text-gray-200">
              Hungry? Let’s fill this cart with delicious food.
            </p>
            <button
              onClick={() => navigate('/')}
              className="dark:bg-darkPrimary bg-primary mx-auto mt-1 block cursor-pointer rounded-md px-4 py-1 font-bold text-white"
            >
              Home
            </button>
          </div>
