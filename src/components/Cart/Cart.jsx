...
const Cart = () => {
    ...
    if (mainCart.length !== 0) {
        ...
        return <>
            <main className={`w-full ${!overflowing  && "h-full"} bg-gray-200`}>
                <div className="w-full flex flex-col max-md:gap-3 md:flex-row justify-between  md:max-w-[1070px] pt-20 max-md:px-1.5 md:pt-28 pb-12 mx-auto md:px-3">
