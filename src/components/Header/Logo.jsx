...
// 
  return (
    <div className="flex gap-1.5 md:gap-6 items-center">
      ...
      {searchPlaceholder ? (
        <p className="flex items-center font-bold text-xl max-w-60 md:max-w-80 truncate"><span className="truncate">
        ...
        >
          ...
          <div className="flex gap-2 items-center justify-center max-md:-mt-1">
            <span className="max-w-52 truncate text-start font-medium text-gray-600 max-md:text-sm ">
            {yourCurrentCity
              ? `${searchedCityAddress}`
