...
// 
  return (
    <div className="flex gap-1.5 md:gap-6 items-center">
      ...
      {searchPlaceholder ? (
        <p className="flex items-center font-bold text-xl max-w-56 md:max-w-80 truncate"><span className="truncate">
        ...
        >
          ...
          <i className="ri-arrow-drop-down-line text-[#ff5200] text-4xl font-[200] md:-ml-2.5 "></i>
          </div>
        </button>
      )}
    </div>
