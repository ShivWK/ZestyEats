...
const ItemsSubHeading = memo(
  ({ title, itemCards, borderBottom = true, restaurantData = null }) => {
    ...
    return (
      ...
      >
        <div
          onClick={handleClick}
          className={`flex cursor-pointer items-center justify-between p-2 ${isOpen ? 'bg-[rgba(255,81,0,0.15)] dark:text-white' : 'bg-white dark:bg-gray-800 dark:text-white'}`}
          style={{
        ...
        >
          ...
          <i
            className="ri-arrow-drop-down-line -ml-2.5 inline-block text-4xl font-[200] text-[#ff5200]"
            style={{
        ...
        <div
          ref={contentRef}
          className="linear overflow-hidden transition-all duration-300"
          style={{
