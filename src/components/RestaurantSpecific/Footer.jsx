...
const Footer = ({ license, address }) => {
    return (
        <>
            <div className="w-full p-4 pb-1 dark:bg-gray-300 bg-gray-100">
                <div id="lisence" className="flex items-center gap-4">
                    <img
                        ...
                        alt="License"
                    />
                    <p className="font-semibold text-gray-500 dark:text-gray-700 text-sm mt-2">
                        {license?.card?.card?.text.toString()}
                    </p>
                </div>
                <hr className="dark:text-gray-700 text-gray-500 my-4" />
                <div id="address" className="">
                    <p className="font-bold text-gray-500 dark:text-gray-600">{address?.card?.card?.name}</p>
                    <p className="text-sm -mt-1 text-gray-700 dark:text-gray-800">{`(Outlet: ${address?.card?.card?.area})`}</p>
                    <div className="flex gap-2 mt-2 items-center ">
                        <i className="ri-map-pin-line text-xl text-gray-500 dark:text-gray-600"></i>
                        <p className="text-sm text-gray-500 font-semibold dark:text-gray-600">
