...
const MainContent = ({ data, routes = true }) => {
  ...
  return (
    <div className="flex items-center flex-col pt-24 mx-auto w-full md:max-w-[800px]">
      ...
      {/* menu button */}
      <button className="fixed bottom-3.5 right-1 md:right-72 h-[12vh] md:w-[12vh] w-[4] rounded-[50%] bg-black text-white text-xs font-bold shadow-[0_0_10px_5px_rgba(0,0,0,0.4)] cursor-pointer">
        MENU
      </button>
    </div>
  );
