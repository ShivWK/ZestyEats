  ...
  return (
    <main className="flex flex-col gap-3 md:gap-5 w-full md:max-w-[1210px] pt-20 md:pt-32 p-3 mx-auto">
      ...
      <div className="shorter rounded-md flex gap-3">
        ...
        <div className="h-9 w-28 rounded-3xl shimmerBg"></div>
      </div>
      ...
      <div className="flex w-full gap-3 flex-col md:flex-row md:gap-6 p-1 max-md:px-2 flex-wrap">
        {arr.map((item, index) => {
          return (
            <div
              key={index}
              className="w-full md:w-[270px] h-52 md:h-72 rounded-2xl md:rounded-xl shrink-0 flex md:flex-col flex-row gap-1.5 p-1.5 border-[1px] border-gray-200"
            >
