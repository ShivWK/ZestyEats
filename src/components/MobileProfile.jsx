        ...
        <section className="relative px-3 pt-5 pb-2 bg-primary/70 rounded-b-3xl h-40 profile-animation overflow-hidden">
            ...
            <div className="flex items-center justify-between mt-2.5">
                <div>
                    ...
                    <p className="font-medium text-gray-800 dark:text-gray-200">7897532327</p>
                    <p className="font-medium text-gray-800 dark:text-gray-200 -mt-1 tracking-wide">shivendra@shivendra.site</p>
                </div>
