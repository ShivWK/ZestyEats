    ...
    <div className="">
      {wishlist ? (
        wishlist.length !== 0 ? (
          wishlist.map((data) => (
            <RestaurantCard
              key={data.restro.metadata?.id || data.restro.id}
              data={data}
            />
          ))
        ) : (
          <div className="flex h-full flex-col items-center justify-center gap-6 pb-4">
            <svg
              ...
              className="mt-10 h-[250px] w-[300px] lg:mt-8 lg:h-[300px] lg:w-[350px]"
              width="647.63626"
              height="632.17383"
            ...
            >
              ...
              <path
                ...
                fill="#ff5200"
              />
              <circle cx="190.15351" cy="24.95465" r="20" fill="#ff5200" />
              ...
              <path
                ...
                fill="#ff5200"
              />
              <circle cx="433.63626" cy="105.17383" r="20" fill="#ff5200" />
              <circle cx="433.63626" cy="105.17383" r="12.18187" fill="#fff" />
            </svg>
            <p className="text-center font-semibold text-gray-700 dark:text-gray-200">
              Craving something? Add it to your wishlist.
            </p>
            <p className="-mt-5 font-medium text-gray-600 dark:text-gray-300">
