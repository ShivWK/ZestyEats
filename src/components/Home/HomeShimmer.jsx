...
const HomeShimmer = () => {
    ...
    return (
        <div className="w-full flex flex-col gap-3 mt-5">
            ...
            <div className="flex justify-between gap-x-4 gap-y-5 flex-wrap max-md:px-3">
                {bestPlaces.map((i) => (
                    <div key={i} className="w-28 h-10 md:w-60 md:h-20 rounded-xl shimmerBg shrink-0"></div>
                ))}
            </div>
