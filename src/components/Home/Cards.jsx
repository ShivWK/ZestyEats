...
const Cards = memo(({ data, from }) => {
  ...
  return (
    <NavLink
      ...
      className={`flex flex-row md:flex-col items-center rounded-2xl overflow-hidden shrink-0 hover:scale-95 transition-all duration-100 ease-in-out border-[1px] border-gray-400`}
    >
      <div
