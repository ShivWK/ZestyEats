const EnteryDiv = ({ handleDivClick, hasValue, inputRef, handleInput, handleFocus, placeholder, fallbackPlacehoder, focus, isReadOnly = false }) => {
    return (
        <div onClick={handleDivClick} className="relative p-2.5 border-2 border-gray-400 h-[70px] cursor-text">
            ...
            <input readOnly={isReadOnly} onFocus={handleFocus} ref={inputRef} onChange={handleInput} className="relative top-5 font-bold text-lg outline-none" type="tel" />
        </div>
    )
}
