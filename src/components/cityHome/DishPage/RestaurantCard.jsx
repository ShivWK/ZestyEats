...
const RestaurantCart = ({ data, latLng }) => {
    ...
    return <section className=" rounded-xl m-0.5 my-4 md:my-4 dark:bg-gray-300 bg-white">
        <div className="px-2 py-2 w-full flex flex-col gap-0.5">
            ...
            >
                <p className="basis-[90%] dark:text-black md:basis-[96%] truncate text-xl font-bold select-none">
                    {restaurantData.name}
                </p>

                <i className="basis-[8%] md:basis-[3%] active:text-primary ri-arrow-right-long-fill text-2xl text-gray-900 dark:text-black cursor-pointer transform group-hover:translate-x-[6px] transition-all duration-150 ease-in-out"></i>
            </Link>

            <p className="text-xs md:text-sm font-bold text-gray-700 truncate -mt-1 dark:text-gray-950">{areaOrLocality}</p>

            <div className="flex gap-1 items-center dark:text-gray-800 text-gray-600 font-semibold text-sm">
            ...
            <hr className="text-gray-300 dark:text-gray-600 mt-1" />
            <div className="">
