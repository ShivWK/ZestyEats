const LocalityShimmer = () => {
    ...
    const { foodie, topChain, topOnline } = mappingArrays;

    return <main className="w-full md:max-w-[1070px] mx-auto pb-8 md:pb-10 pt-20 md:pt-28 overflow-x-hidden max-md:px-1.5">
...
export default LocalityShimmer;