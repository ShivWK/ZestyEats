...
const MainContent = ({ data }) => {
    ...
    return <><main className="w-full md:max-w-[1070px] mx-auto pt-20 md:pt-28 overflow-x-hidden max-md:px-1.5">
        ...
        <div
            id="banner"
            className="flex flex-col mt-0.5 md:mt-1 mb-4 md:mb-8 w-full max-md:rounded-e-3xl md:rounded-t-4xl bg-cover md:h-[50vh] h-[30vh] bg-[url('/images/food-banner.jpg')] p-5 max-md:pl-2.5 max-md:bg-right"
        >
...
const CityCuisines = () => {
    ...
    return <Suspense fallback={<>
        ...
        <div className="my-8 max-md:mb-0 md:block hidden">
            <ScooterAnimation />
        </div>
    </>
    }>
